...
class HeadPosesProvider():
    ...
    """
    def __init__(self):
    	self.__ctx = UnderworldsProxy("human_provider", PROVIDER)
        ...
        self.pose3D_sub = rospy.Subscriber('/pose3D', PeoplePoseArray, self.handle_body3D, queue_size=1)
